...
function beginWork(
  ...
  switch (workInProgress.tag) {
    ...
    case HostComponent:
      ...
      // completeWork 中的同名函数 updateHostComponent 中则是给已经存在真实 DOM 节点（stateNode）元素更新打上 effectTag 标签，告诉 react 要 commit 的东西， 并
      // 为不存在真实 DOM 节点的元素创建 DOM节点并赋值给 workInProgress.stateNode
